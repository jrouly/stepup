...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field admingroups on 'Person'
        m2m_table_name = db.shorten_name(u'stepup_person_admingroups')
    ...
    def backwards(self, orm):
        # Removing M2M table for field admingroups on 'Person'
        db.delete_table(db.shorten_name(u'stepup_person_admingroups'))
