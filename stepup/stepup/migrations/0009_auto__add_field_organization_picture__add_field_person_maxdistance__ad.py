...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.picture'
        db.add_column(u'stepup_organization', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100),
                      keep_default=False)

        # Adding field 'Person.maxdistance'
        db.add_column(u'stepup_person', 'maxdistance',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'Person.picture'
        db.add_column(u'stepup_person', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.picture'
        db.delete_column(u'stepup_organization', 'picture')

        # Deleting field 'Person.maxdistance'
        db.delete_column(u'stepup_person', 'maxdistance')

        # Deleting field 'Person.picture'
        db.delete_column(u'stepup_person', 'picture')
